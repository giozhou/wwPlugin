========================================================================
    ACTIVE TEMPLATE LIBRARY : uomschat Project Overview
========================================================================

AppWizard has created this uomschat project for you to use as the starting point for
...
uomschat.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (uomschat.h)
        GUID definitions                                (uomschat_i.c)
        A type library                                  (uomschat.tlb)
        Marshaling code                                 (uomschat_p.c and dlldata.c)

uomschat.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in uomschat.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named uomschat.pch and a precompiled types file named StdAfx.obj.
...
uomschatps.vcxproj
	...
	dlldata.c, uomschat_i.c and uomschat_p.c which are required
	to build the proxy/stub DLL.

uomschatps.vcxproj.filters
